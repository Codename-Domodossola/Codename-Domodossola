...
- `node-types.yaml` — Canonical definitions referenced by deployment roles.
- `tech-requirements.md` — Hardware/software/network constraints and dependencies.
- `CHANGELOG.md` — Record of versioned changes to this deployment example.

See project root for licensing and contribution information.
